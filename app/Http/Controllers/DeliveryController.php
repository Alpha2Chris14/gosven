...
class DeliveryController extends Controller
{
    ...
    public function getByDate($date){
        $data['title'] = "Order By Date";
        $data['categories'] = Category::all();
        //$data['transactions'] = Payonline::('created_at','=',$date);
        $data['transactions'] = Pod::where('date','=',$date)->get();
        //return view('admin.online.date',$data);
        echo $data['transactions'][0];
        echo "<hr>";
