        ...
        <div class="child-container">
            ...
            <main class="similar-main">
                ...
                <section class="verify-section">
                    ...
                    <div class="content">
                        <form action= "{{ route('product.store') }}" enctype="multipart/form-data" method="post" class="similar-form">
                            @csrf
                            <div>
                                <label for="product-name" class="input-labels">Name of Product</label>
                                <input type="text" name="name" id="product-name" placeholder="" class="input-field" required>
                                <div class="share-width-input">
                                    <div>
                                        <label for="price" class="input-labels">Price</label>
                                        <input type="text" name="price" id="price" placeholder="" class="input-field" required>
                                    </div>
                                    <div>
                                        <label for="previous-price" class="input-labels">Previous Price</label>
                                        <input type="text" name="previous" id="previous-price" placeholder="" class="input-field" required>
                                    </div>
                                </div>
                                <div class="share-width-input">
                                    <div>
                                ...
                                <div class="share-width-input">
                                    ...
                                    <div>
                                        ...
                                        <input type="file" name="image" id="upload-img" placeholder="" class="input-field file-upload" required>
                                    </div>
                                </div>
                                <div class="share-width-input">
                                    <div>
                                        <label for="upload-video" class="input-labels">Upload Video</label>
                                        <input type="file" name="featured_video" id="upload-video" placeholder="" class="input-field file-upload" required>
                                    </div>
                                    <div>
                                        <label for="weight" class="input-labels">Weight</label>
                                        <input type="text" name="weight" id="about-farm" placeholder="" class="input-field" required>
                                    </div>
                                </div>   
